...
import fr.odevjava.whatsapp_clone_back.messaging.domain.message.vo.*;
...
public class Message {
    ...
    private void assertMandatoryFields(MessageSentTime sentTime, MessageContent content,
        ...
        Assert.notNull("sendState", sendState);
